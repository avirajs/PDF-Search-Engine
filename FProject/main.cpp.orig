...
// se.addDocumentsToIndex("/home/coder/Documents/sampleCorpus/");
  ...
  // {
   ...
   // }
 //   se.addBookmark("21574.pdf","Japanese");
 //   se.addBookmark("hknjknkj.pdf","AND Boston Seattle");
//    se.addBookmark("kkkkk.pdf","Japanese NOT Boston");
 //   se.clearBookmarks();
//    se.displayBookmarks();
   // se.readBookmarks();
   // se.getTotalPages();
 //   se.clear();
   // se.addDocumentsToIndex("/home/coder/Documents/Corpus01/sampleCorpus/");
  //  se.chooseStructure('H');
   // se.clear();
   // se.addDocumentsToIndex("/home/coder/Documents/corpus_2/corpus/");
  //  se.chooseStructure('H');
      //se.display_search_results("OR Boston innovtion");
 //     se.addToHistory("OR Boston innovtion");
 //     se.displayHistory();
  //  se.display_search_results("AND Boston innovation");
   // se.clear();
 ...
 //   se.clear();
    int num =0;
  //  num = se.readTotalPages();
    //se.addDocumentsToIndex("kkkk");
   // se.readFilePathFromTXTFile();
   // boo =se.displayRawFile("/home/coder/Documents/corpus_2/corpus/5018.pdf");
   // cout << "Boo is:" << boo << endl;
